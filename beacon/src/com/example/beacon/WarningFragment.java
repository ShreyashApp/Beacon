 ...
 */
public class WarningFragment extends Fragment implements LocationListener,
...
View rV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            rV = inflater.inflate(R.layout.warning_map, null, false);
        } catch (InflateException e) {
        }
         mapfragment = (SupportMapFragment)getActivity().getSupportFragmentManager().findFragmentById(R.id.war_frag);
        radius = Application.getSearchDistance();
        ImageButton home =(ImageButton)rV.findViewById(R.id.home);
        ImageButton settings = (ImageButton)rV.findViewById(R.id.settings);
        ImageButton warning = (ImageButton)rV.findViewById(R.id.warning);
        ImageButton post = (ImageButton)rV.findViewById(R.id.post);
        ...
        warning.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity(), Warning.class);
                intent.putExtra(Application.INTENT_EXTRA_LOCATION, myLoc);
                startActivity(intent);
            }
        });
        ...
        mapQuery1.findInBackground(new FindCallback<Warnings>() {
            ...
            public void done(List<Warnings> objects, ParseException e) {
                ...
                for (final Warnings post1 : objects) {
                    ...
                    Marker marker = mgoogle.addMarker(markerOpts);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mapfragment == null) {
            ...
            fragmentTransaction.replace(R.id.war_frag, mapfragment).commit();
        }
    }
